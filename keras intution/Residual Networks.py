...
def ResNet50(input_shape = (64, 64, 3), classes = 6):
    ...
    X=Flatten()(X)
    X=Dense(classes,'softmax',name='fc'+ str(classes), kernel_initializer = glorot_uniform(seed=0))(X)
...
model.fit(X_train, Y_train, epochs = 375, batch_size = 32,callbacks=[loss_print()])
